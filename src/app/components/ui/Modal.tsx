...
const Modal = ({children}: Modal) => {
	...
	const closeModalHandler = (): void => {
		useModal.setState(() => ({visibility: "hidden"}))
	}
			...
			<Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => closeModalHandler()}>
				...
				<div className="fixed z-10 inset-0 overflow-y-auto">
					<div className="flex items-center justify-center min-h-full p-4 text-center sm:p-0">
						...
						>
							<Dialog.Panel className="relative bg-white rounded-lg text-left py-6 px-12 overflow-hidden shadow-xl transform transition-all w-11/12 sm:w-11/12 md:w-7/12">
